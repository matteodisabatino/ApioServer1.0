...
angular.module('ApioApplication').controller('ApioWallController', ['$scope', '$http', 'socket', 'objectService', 'currentObject', function ($scope, $http, socket, objectService, currentObject) {
        ...
        objectService.getById(id).then(function (d) {
            ...
            $.get("applications/" + id + "/" + id + ".html", function (data) {
                ...
                var interval = setInterval(function () {
                    var x = $("#registra_statoinput").trigger("click");
                    if (x[0]) {
